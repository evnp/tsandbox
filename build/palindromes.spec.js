...
describe("longest palindromic substring", () => {
    let randomStringInputs;
    const randomStringOutputs = {};
...
function longestPalindromeBrute(str, log = "") {
    let subStrA = "";
    let subStrB = "";
    let subStrC = "";
    log += "\n" + str;
...
function longestPalindromeMemo(str) {
    const memo = [];
    //let stackSize = 0;
    // ARGUMENTS
    ...
    function longest(start, end) {
        ...
        if (!result) {
            if (end - start <= 0) {
                ...
                if ((subEndA - subStartA > subEndB - subStartB &&
...
function longestPalindromeIter(str) {
